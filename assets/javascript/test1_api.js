...
//<p id="demo"></p>
      ...
      //for loop over bandId and gather the name, genre & venue, if any.(not any in this example)
          console.log("run a for loop on response")
          for (var i = 0; bandId.data.length; i++) {
              text += "The band id is " + bandId.data[i].id + "<br>";
              text1 += "The band name is " + bandId.data[i].name + "<br>";
              text2 += "The band genre is " + bandId.data[i].genre + "<br>";
